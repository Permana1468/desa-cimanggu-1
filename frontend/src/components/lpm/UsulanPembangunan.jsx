    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({
                ...
                volume: '', titik_koordinat: '', foto_1: null, foto_2: null, foto_3: null
            });
            fetchUsulan();
        } catch (error) {
                            ...
                            <div className="p-6 overflow-y-auto custom-scrollbar">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="md:col-span-2 space-y-4">
                                        ...
                                        <div>
                                            <h4 className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1 mt-4">Urgensi / Latar Belakang</h4>
